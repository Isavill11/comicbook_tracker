...
'''UNLESS I OPTIMIZE THIS LATER: 
Add any comic series/names that you do not want in your list and this script will delete them from your preexisting json dictionary. 
The raw db will still be kept but a new, filtered one will be created. 
